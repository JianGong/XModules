...
- (void)layoutSubviews
{
    ...
    _refleshView.center = CGPointMake(frame.size.width / 2, 16.0f);
    _activityIndicatorView.center = CGPointMake(frame.size.width / 2, 16.0f);
}
...
//{
//    [super layoutSubviews];
//    self.width=_scrollView.frame.size.width;
//}
